...
## Next steps
- Add proper summarization using the model itself (currently a lightweight heuristic).
- Plug in a real embedding backend for vector recall (e.g., sentence-transformers + FAISS) if you need higher-quality retrieval.
- Add benchmarks to compare memory strategies on scripted conversations.
